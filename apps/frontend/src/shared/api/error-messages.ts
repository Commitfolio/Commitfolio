const ERROR_MESSAGES: Record<string, string> = {
  ...
  invalid_repository_full_name: "저장소 이름은 owner/repo 형식으로 입력해 주세요.",
  repository_not_accessible: "저장소를 찾을 수 없거나 OAuth App이 해당 조직 저장소에 접근할 수 없습니다. 조직의 OAuth App 승인 상태를 확인해 주세요.",
  github_token_missing: "백엔드 재시작으로 GitHub 세션 토큰이 사라졌습니다. 다시 로그인해 주세요.",
